// Edit-product form: loads a product by route index and saves its new values.
...
const EditProduct = () => {
    ...
    useEffect(() => {
        if (id !== undefined && products[id]) {
            setNameProduct(products[id].NAME);
            setCategory(products[id].CATEGROES);
            setPrice(products[id].PRICE);
            setStock(products[id].STOCK);
            setBrand(products[id].BRAND);
            setStatus(products[id].STATUS);
                ...
                <div className='ProductFormGrid'>
                    ...
                    <label className='Field'>
                        ...
                        <select
                            ...
                            {Categories.map((e, i) => (
                                <option key={i}>{e.NameCate}</option>
                            ))}
                        </select>
                    </label>
